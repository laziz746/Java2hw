...
public class Cat extends Animal implements Participant {
    ...
    public Cat(String name, Color color, int age, int runDistance, int jumpHeight, int distance) {
    ...
    public void run(int distance) {
        ...
        System.out.println(String.format("Кошка %s пругнула на высоту %d", getName(), distance));
    }
